...
void LCDdisplay::send_raw_data_one_cycle(uint raw_bits[])
...
LCDdisplay::LCDdisplay(int bit4_pin, int bit5_pin, int bit6_pin, int bit7_pin, int rs_pin, int e_pin, int width, int depth)
{ // constructor
...
LCDdisplay::LCDdisplay(int bit4_pin, int bit5_pin, int bit6_pin, int bit7_pin, int rs_pin, int e_pin, int bl_pin, int width, int depth)
{ // constructor
    this->LCDpins[0] = bit7_pin;
    this->LCDpins[1] = bit6_pin;
    this->LCDpins[2] = bit5_pin;
